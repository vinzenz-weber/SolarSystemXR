Shader "NatureManufacture/URP/Foliage/Bark Snow"
{
    Properties
    {
        ...
        _TrunkTilingOffset("Trunk Tiling and Offset", Vector, 4) = (1, 1, 0, 0)
        ...
        _BarkBlendMaskTilingOffset("Bark Blend Mask Tiling Offset", Vector, 4) = (1, 1, 0, 0)
        ...
        _BarkTilingOffset("Bark Tiling and Offset", Vector, 4) = (1, 1, 0, 0)
        ...
        _SnowTilingOffset("Snow Tiling Offset", Vector, 4) = (1, 1, 0, 0)
        ...
        _NewNormal("Mesh Normal Multiply", Vector, 4) = (0, 0, 0, 0)
